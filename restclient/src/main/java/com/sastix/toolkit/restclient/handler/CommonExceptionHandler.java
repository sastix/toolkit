package com.sastix.toolkit.restclient.handler;

import com.fasterxml.jackson.core.JsonFactory;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.sastix.toolkit.restclient.exception.ToolkitBusinessException;
import com.sastix.toolkit.restclient.exception.StatusCodeException;
...
public class CommonExceptionHandler implements ResponseErrorHandler {
    ...
    public CommonExceptionHandler() {
        exceptionClasses.put(ToolkitBusinessException.class.getName(), ToolkitBusinessException::new);
    }
